...
//       setstories((prev) => prev.filter((stories) => stories.id !== id));
...
//         <meta name="description" content="Welcome To NewYorkLore" />
//       </Helmet>
...
//           {/* Load More Button - Only show if there are stories */}
//           {!loading && !error && stories.length > 0 && (
//             <div className="text-center mt-12">
//               <button className="px-8 py-3 bg-gray-800 hover:bg-gray-700 border border-gray-600 hover:border-emerald-600 text-gray-300 hover:text-emerald-400 font-medium rounded-lg transition-all duration-300">
//                 Load More Stories
//               </button>
//             </div>
//           )}
